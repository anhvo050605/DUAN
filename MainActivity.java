...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linearLoaiSach = findViewById(R.id.LoaiSach);
        LinearLayout linearSach = findViewById(R.id.Sach);

        linearLoaiSach.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, LoaiSach.class));
            }
        });
